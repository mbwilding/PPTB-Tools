...
function App() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            await runCodegen(settings, settingsDir, outputDir, log, __APP_VERSION__, setGenerateProgress);
        ...
        <div className="page-layout">
            ...
            <div className="content-area">
                <div className="settings-search-bar">
                    <input ref={searchInputRef} className="settings-search-input" type="search" placeholder="Filter settings..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                    {searchQuery && (
                        <button
                    ...
                    <div className="settings-panel">
                        ...
                        <PropertySection title="Global">
                            ...
                            <SettingRow label="Token Capitalisation Overrides" hint="Words treated as known tokens during CamelCase naming (e.g. SlaId, VoiceMail)">
                                <StringListEditor
                                    items={settings.tokenCapitalizationOverrides}
                                    onChange={(items) => updateSetting({ tokenCapitalizationOverrides: items })}
                        ...
                        <PropertySection title="Option Sets">
                            ...
                            <SettingRow
                                label="Option Name Overrides"
                                hint="Fix casing of enum member name tokens. Key: lowercase token to match. Value: correctly-cased replacement (e.g. fedex → FedEx)."
                            >
                                <KeyValueEditor
            ...
            <div className="bottom-bar">
                ...
                {isGenerating && <progress className="generate-progress" value={generateProgress} max={100} />}
            </div>
